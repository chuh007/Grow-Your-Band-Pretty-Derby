...
namespace Member.LS.Code.Dialogue.Character.Editor
{
    ...
    {
        private const Single RowPad = 2.0f;
        ...
        public override Single GetPropertyHeight(SerializedProperty property, GUIContent label)
        {
            ...
            return rows * (EditorGUIUtility.singleLineHeight + RowPad) + 6.0f;
        }
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            line.y += EditorGUIUtility.singleLineHeight + RowPad;
            ...
            if (allUsed)
            {
                Rect warn = new Rect(addRect.x, addRect.y + EditorGUIUtility.singleLineHeight + RowPad,
